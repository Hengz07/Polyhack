...
<div class="card">
    <div class="card-body">
        ...
        <div class="row  mb-3">
            <div class="col-4"></div>
            <div class="col-2 text-bold text-center">MIN<span style="color: red"> *</span></div>
                
            <div class="col-2 text-bold text-center">MAX<span style="color: red"> *</span></div>
            <div class="col-4"></div>
        </div>
        ...
        @foreach ($meta as $key => $cat)
            <div class="row  mb-3">
                <div class="col-2"></div>
                    <div class="col-2 text-bold">{{ $cat['name'] }}</div>
