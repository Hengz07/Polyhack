...
<div class="card">
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-sm-1 text-bold">Category<span style="color: red">*</span></div>
            <div class="col-sm-1 text-bold"> :</div>
            <div class="col-sm-10"> 

                <select class="form-control selCategory" id="namecode" name="category" style="width: 100%;" required>
                    @if (!empty($meta))
                        <option value="{{ $meta['code'] }} - {{ $meta['name']}}">{{ $meta['code'] }} - {{ $meta['name']}}</option>
                    @endif
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-sm-1 text-bold">Code<span style="color: red">*</span></div>
            <div class="col-sm-1 text-bold"> :</div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-1 text-bold">Order<span style="color: red">*</span></div>
            <div class="col-sm-1 text-bold"> :</div>
            <div class="col-sm-4"> 
        ...
        <div class="row mb-3">
            <div class="col-sm-1 text-bold">Question (BM)<span style="color: red">*</span></div>
            <div class="col-sm-1 text-bold"> :</div>
            <div class="col-sm-10">
        ...
        <div class="row mb-3">
            <div class="col-sm-1 text-bold">Question (BI)</div>
            <div class="col-sm-1 text-bold"> :</div>
            <div class="col-sm-10">
