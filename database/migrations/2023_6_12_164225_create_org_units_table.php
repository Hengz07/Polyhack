...
class CreateOrgUnitsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('org_units', function (Blueprint $table) {
            ...
            // $table->foreign('department_id')->on('org_departments')->references('id')->onDelete('cascade');
            // $table->foreign('division_id')->on('org_divisions')->references('id')->onDelete('cascade');
            // $table->foreign('section_id')->on('org_sections')->references('id')->onDelete('cascade');
